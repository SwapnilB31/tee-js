 ...
 */
function createTeeIterators<T>(sourceIterable: Iterable<T>, count: number): IterableIterator<T>[] {
 ...
 */
function teeConsumers<T>(this: Array<T>, ...consumers: TeeConsumer<T>[]): (any)[] {
